...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-[white] text-[#8B9D83] shadow hover:bg-[#8B9D83] hover:text-white",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-[#8B9D83] hover:text-white",
        outline:
          "border border-input  shadow-sm hover:bg-accent hover:text-accent-foreground hover:text-white",
        secondary:
